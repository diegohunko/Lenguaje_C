...
\begin{figure*}[!htb]
\includegraphics[scale=0.50]{FCFS.eps}
\end{figure*}
\begin{tabular}{l l}
...
\begin{figure*}[!htb]
\includegraphics[scale=0.50]{Prioridad-noApropiativo.eps}
\end{figure*}
\begin{tabular}{l l}[!htb]
Tiempos de retorno & Tiempo de espera\\
$P_0 =-(0 - 9)= 9$   & $P_0 = 0$ \\
$P_1 =-(1 - 15)= 14$ & $P_1 = 10-1= 9$ \\
...
SJF No Apropiativo:\\
\begin{figure*}[!htb]
\includegraphics[scale=0.50]{SJF-noApropiativo.eps}
\end{figure*}
\begin{tabular}{l l}[!htb]
Tiempos de retorno & Tiempo de espera\\
$P_0 =-(0 - 9)= 9$   & $P_0 = 0$ \\
...
\begin{figure*}[!htb]
\includegraphics[scale=0.50]{Prioridad-Apropiativo.eps}
\end{figure*}
\begin{tabular}{l l}[!htb]
...
SJF Apropiativo:\\
\begin{figure*}[!htb]
\includegraphics[scale=0.50]{SJF-Apropiativo.eps}
\end{figure*}
\begin{tabular}{l l}[!htb]
Tiempos de retorno 		& Tiempo de espera\\
...
Round Robin:\\
\begin{figure*}[!htb]
\includegraphics[scale=0.50]{Round-Robin.eps}
\end{figure*}
\begin{tabular}{l l}[!htb]
Tiempos de retorno 		& Tiempo de espera\\
$P_0 = 33$   		 	& $P_0 = 0$ \\
